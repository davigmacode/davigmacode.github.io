<section class="container">
  <div class="content">
    ...
    <div>
      ...
      <a class="contact" target="_blank" rel="noreferrer" href="https://github.com/davigmacode">
...
<style lang="postcss">
  ...
  .name {
    @apply mb-3 mt-4 text-5xl;
  }
  .title {
    @apply mb-7 text-3xl;
  }
  .avatar {
    @apply inline-block h-32 w-32 rounded-full ring-2 ring-white;
  }
  .contact {
    @apply flex items-center space-x-5 mt-4 text-xl;
  }
  .contact svg {
    @apply h-8 w-8;
  }
